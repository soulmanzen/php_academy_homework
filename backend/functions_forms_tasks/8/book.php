...
<div class="container">
    ...
    <div>
         ...
         * @return bool
         */
        function isMat(string $str, array $black_list):bool
        {
        ...
        if (isset($_POST['name']) && isset($_POST['message'])) {
            if (!empty($_POST['message']) && !empty($_POST['name'])) {
                if (ctype_alpha(str_replace(' ', '', $_POST['name']))) {
                    if (isMat($_POST['message'], $black_list)) {
        ...
        foreach ($messages as $mess) {
            echo "<div class=\"message\"><div class='date'>" . $mess['datetime'] .
                "</div><span class='name'> " . $mess['name'] . ': ' . "</span><span>" .
                strip_tags($mess['message'], '<b>') .  "</span></div>";
        }
        ?>
    ...
    <div>
        ...
        <textarea class="text" name="message" placeholder="Enter your message..."><?php
            echo isset($_POST['message']) ? $_POST['message'] : ''; ?></textarea>
